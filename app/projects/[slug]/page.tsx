...
import { getProjectMockup, projectVariants } from '@/components/projects/mockups'
...
export default function ProjectDetailPage() {
  ...
  const projectData = t.projectDetail.projects[slug as keyof typeof t.projectDetail.projects]
  ...
  return (
    <>
      {/* Back Link */}
      <section className="section" style={{ paddingTop: 'var(--space-32)', paddingBottom: 0 }}>
        ...
        <div className="container">
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: 'var(--space-6)' }}>
            <div>
              ...
              <span style={{ fontWeight: 600, color: 'var(--fg-default)' }}>{lang === 'ar' ? meta.timelineAr : meta.timelineEn}</span>
            </div>
            <div>
              <span style={{
                fontFamily: 'var(--font-mono)',
              ...
              <span style={{ fontWeight: 600, color: 'var(--fg-default)' }}>{meta.tech.slice(0, 3).join(', ')}</span>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container">
          <div className="split-section">
            <div className="split-content">
              <span className="section-label">{t.projectDetail.theChallenge}</span>
              <p style={{
                fontSize: 'var(--text-xl)',
                color: 'var(--fg-default)',
                lineHeight: 1.7,
            ...
            <div className="split-image">
              <div className="mockup-screenshot">
                {challengeVariant && getProjectMockup(slug, challengeVariant.id)}
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="section">
        <div className="container">
          <div className="split-section split-section--reverse">
            <div className="split-content">
              <span className="section-label">{t.projectDetail.theSolution}</span>
              <p style={{
                fontSize: 'var(--text-xl)',
                color: 'var(--fg-default)',
                lineHeight: 1.7,
      ...
      <section className="section">
        <div className="container">
          <div className="section-header">
            <span className="section-label">{t.projectDetail.moreProjects}</span>
          ...
          <div className="project-grid">
            {meta.related.map((relatedSlug) => {
              ...
              const relatedProject = t.projectDetail.projects[relatedSlug as keyof typeof t.projectDetail.projects]
              ...
              return (
                ...
                >
                  ...
                  <div className="project-body">
                    <span className="project-tag">{relatedProject.industry}</span>
                    <h3 className="project-title">{relatedMeta.title}</h3>
                    <p className="project-description">{relatedProject.description}</p>
                  </div>
                </Link>
              )
            })}
